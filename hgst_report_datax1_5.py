...
import sys
print("\n")
print('This is \'Beta\' version 1.5 . This utility collects useful information from Data60 and Data102 JBODs. This version doesn\'t verify HTTP Certificate. Press Ctrl+C if you do not wish to continue.')
print("\n")

parser = argparse.ArgumentParser(description='This is \'Beta\' version 1.5 . This utility collects useful information from Data60 and Data102 JBODs. This version doesn\'t verify HTTP Certificate')
